...
$result=mysqli_num_rows($db->view_recordinprocess());
$result2=mysqli_num_rows($db->view_recordclosed());
$result3=mysqli_num_rows($db->view_recordnotprocess());
$result4=mysqli_num_rows($db->view_expiredcomplaints());
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <ul class="navbar-nav left-side-nav" id="accordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                    ...
                    <ul class="sidenav-second-level collapse show" id="dashboard" data-parent="#accordion">
                        ...
                        <li> <a href="##"></a></li>
                        <?php if($_SESSION["role"]=="Entery Operator") {?>
                            <li> <a href="showcomplaint.php">All Complaints</a></li>
                        <li> <a href="newcomplaint.php">Add New Complaint</a></li>

                        <?php } else{?>
                        <li> <a href="notprocessyetcomplaints.php">Not Process Yet<b class="label orange pull-right"><?php echo $result3; ?></b></a></li>
                        <li> <a href="inprocesscomplaints.php">In Process<b class="label orange pull-right"><?php echo $result; ?></b></a></li>
                        <li> <a href="closedcomplaints.php">Closed<b class="label green pull-right"><?php echo $result2; ?></b></a></li>
                        <li> <a href="expiredcomplaints.php">Expired<b class="label green pull-right"><?php echo $result4; ?></b></a></li>
                        <?php } ?>
                         </ul>
                </li>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Exra Pages">
                    ...
                    <ul class="sidenav-second-level collapse" id="extra_pages" data-parent="#accordion">
                        <li> <a href="showsubcategory.php">Show Subcategories</a> </li>
